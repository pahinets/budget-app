    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div>
            <label style={{ display: 'block', fontSize: '0.625rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', opacity: 0.9, color: '#374151', marginBottom: '0.5rem' }}>
              {t('auth.identity')}
            </label>
            <input type="email" required value={email}
              onChange={e => setEmail(e.target.value)}
              style={inp} placeholder={t('auth.identity_placeholder')} />
          </div>
          ...
          <div>
            ...
            <input type="password" required value={password}
              ...
              style={inp} placeholder={t('auth.passphrase_placeholder')} />
          </div>
